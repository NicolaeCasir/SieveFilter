...
<form class="new_filter" id="new_filter" action="/mail_filters" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓">
    {{csrf_field()}}
    <input type="hidden" name="authenticity_token" value="q0/dUMBDDosL3dpJMEbA/YC8snyILVjD46I+klfaLvDctGJRDu1MEbYyIPlVkJ9b9iAO/OeT8hE6sXUmlX/B0g=="><div class="form-group">
...
<tbody><tr>
<td>
<select name="filter[boolean_operator]" v-model="filter.boolean_operator" id="filter_boolean_operator" class="form-control"><option value="allof">All Of</option>
<option selected="selected" value="anyof">Any Of</option></select>
</td>
</tr>
<tr v-for="(ex, index) in expressions">
<td>
<select :name="'expression[' + index + '][field_name]'" v-model="ex.field_name" id="expression_1_field_name" class="form-control"><option selected="selected" value=""></option>
<option value="From">From</option>
<option value="To">To</option>
<option value="CC">CC</option>
<option value="Subject">Subject</option>
<option value="Body">Body</option>
<option value="List-Id">List-Id</option></select>
</td>
<td>
<select :name="'expression[' + index + '][operator]'" id="expression_1_operator" v-model="ex.operator" class="form-control"><option value="contains">Contains</option>
<option value="starts">Starts With</option>
<option value="ends">Ends With</option>
<option value="exactly">Is Exactly</option></select>
</td>
<td>
...
<span class="help-block">The folder name is case sensitive. To delete the message, send to the
"Trash" folder.
</span>
</div>
<div class="form-group">
...
<input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="AeYF1xWfwDvEs/UwO2DU97WBBA2o8Pk4L4AtMWfMvh52HbrW2zGCoXlcD4BetotRwx24jcdOU+r2k2aFpWlRPA==">
